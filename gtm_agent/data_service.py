...
def update_prospect_info(prospect_id, technology):
    ...
    persisted_tech_stack = PROSPECTS[prospect_id]["tech_stack"]
    if technology not in persisted_tech_stack:
        return {"updated": False, "found": True}
    return {"updated": True, "found": True, "tech_stack": persisted_tech_stack}
